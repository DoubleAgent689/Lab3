...
public class List2 implements GetSet {
    ...
    List2(ArrayList<Integer> paragraphСount, String name, int intrParphCount) {
    ...
    public void setIntrParphCount(int intrParphCount) throws WrongParException  {
        if (intrParphCount < 0) {
            throw new WrongParException("Incorrect StudyBook intrParghCount");
        }
        this.intrParphCount = intrParphCount;
    }
    ...
    public void setParagraphСount (ArrayList<Integer> paragraphСount) {
        if (paragraphСount == null) {
            throw new ParagraphCountIsNullRuntimeException("StudyBook paragraphCount is null");
