...
public class List1 implements GetSet {
    ...
    List1(ArrayList<Integer> paragraphСount, String name, int intrParphCount) {
    ...
    public void setIntrParphCount(int intrParphCount) throws WrongParException {
        if (intrParphCount < 0)
        {
            throw new WrongParException("Incorrect Book intrParghCount");
        }
        this.intrParphCount = intrParphCount;
    }
    ...
    public void setParagraphСount(ArrayList<Integer> paragraphСount) {
        ...
        {
            throw new ParagraphCountIsNullRuntimeException("Book paragraphCount is null");
        }
        this.paragraphСount = paragraphСount;
    }
